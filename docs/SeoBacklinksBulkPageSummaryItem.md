# Unifapi::SeoBacklinksBulkPageSummaryItem
...
| **main_domain_rank** | **Integer** | Backlink rank of the page&#39;s root domain. | [optional] |
...
instance = Unifapi::SeoBacklinksBulkPageSummaryItem.new(
  url: null,
