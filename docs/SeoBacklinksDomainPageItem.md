# Unifapi::SeoBacklinksDomainPageItem
...
| **status_code** | **Integer** | Last HTTP status code seen for the page. | [optional] |
| **first_visited** | **String** | Date DataForSEO first crawled the page. | [optional] |
| **fetch_time** | **String** | Date the page was last crawled. | [optional] |
| **size** | **Integer** | Page size in bytes. | [optional] |
| **media_type** | **String** | Media type of the page, e.g. text/html. | [optional] |
...
instance = Unifapi::SeoBacklinksDomainPageItem.new(
  url: null,
  domain: null,
  ip: null,
  status_code: null,
