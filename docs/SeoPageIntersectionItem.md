# Unifapi::SeoPageIntersectionItem
...
| **page_rankings** | [**Array&lt;SeoSerpElement&gt;**](SeoSerpElement.md) | Ranking position of each requested page for the keyword, in request order. | [optional] |
...
instance = Unifapi::SeoPageIntersectionItem.new(
  keyword: null,
  search_volume: null,
  cpc: null,
  competition: null,
