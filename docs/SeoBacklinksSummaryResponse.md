# Unifapi::SeoBacklinksSummaryResponse
...
| **crawled_pages** | **Integer** | Number of target pages DataForSEO has crawled. | [optional] |
| **internal_links_count** | **Integer** | Number of internal links found across the crawled target pages. | [optional] |
| **external_links_count** | **Integer** | Number of external links found across the crawled target pages. | [optional] |
...
instance = Unifapi::SeoBacklinksSummaryResponse.new(
  target: null,
  view: null,
  crawled_pages: null,
