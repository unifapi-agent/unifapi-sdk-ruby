...
module Unifapi
  class SeoBacklinksListRequest
    ...
    attr_accessor :search_after_token
    ...
    def self.openapi_types
      {
        ...
        :'filters' => :'SeoBacklinksListRequestFilters',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Unifapi::SeoBacklinksListRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Unifapi::SeoBacklinksListRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'search_after_token')
        self.search_after_token = attributes[:'search_after_token']
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ["as_is", "one_per_domain", "one_per_anchor"])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ["as_is", "one_per_domain", "one_per_anchor"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit == o.limit &&
          offset == o.offset &&
          search_after_token == o.search_after_token &&
          view == o.view
    end
    ...
    def hash
      [target, mode, backlinks_status_type, include_subdomains, include_indirect_links, exclude_internal_backlinks, rank_scale, filters, order_by, limit, offset, search_after_token, view].hash
    end
