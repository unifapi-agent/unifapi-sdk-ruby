...
module Unifapi
  class SerpListDevice
    DESKTOP = "desktop".freeze
    MOBILE = "mobile".freeze

    def self.all_vars
      @all_vars ||= [DESKTOP, MOBILE].freeze
    end
    ...
    def build_from_hash(value)
      return value if SerpListDevice.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SerpListDevice"
    end
  end
end
