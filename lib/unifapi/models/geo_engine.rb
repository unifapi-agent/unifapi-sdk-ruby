...
module Unifapi
  class GeoEngine
    CHATGPT = "chatgpt".freeze
    GOOGLE = "google".freeze

    def self.all_vars
      @all_vars ||= [CHATGPT, GOOGLE].freeze
    end
    ...
    def build_from_hash(value)
      return value if GeoEngine.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #GeoEngine"
    end
  end
end
