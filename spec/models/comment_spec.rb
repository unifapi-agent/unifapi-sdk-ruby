...
# Unit tests for Unifapi::Comment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::Comment do
  let(:instance) { Unifapi::Comment.new }

  describe 'test an instance of Comment' do
    it 'should create an instance of Comment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::Comment)
    end
  end
  ...
  describe 'test attribute "is_author_liked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
