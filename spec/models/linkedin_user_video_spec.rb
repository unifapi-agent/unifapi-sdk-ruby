...
# Unit tests for Unifapi::LinkedinUserVideo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::LinkedinUserVideo do
  let(:instance) { Unifapi::LinkedinUserVideo.new }

  describe 'test an instance of LinkedinUserVideo' do
    it 'should create an instance of LinkedinUserVideo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::LinkedinUserVideo)
    end
  end
