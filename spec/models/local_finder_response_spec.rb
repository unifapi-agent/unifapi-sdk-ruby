...
# Unit tests for Unifapi::LocalFinderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::LocalFinderResponse do
  let(:instance) { Unifapi::LocalFinderResponse.new }

  describe 'test an instance of LocalFinderResponse' do
    it 'should create an instance of LocalFinderResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::LocalFinderResponse)
    end
  end
