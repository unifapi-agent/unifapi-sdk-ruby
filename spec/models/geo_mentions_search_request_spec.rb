...
# Unit tests for Unifapi::GeoMentionsSearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::GeoMentionsSearchRequest do
  let(:instance) { Unifapi::GeoMentionsSearchRequest.new }

  describe 'test an instance of GeoMentionsSearchRequest' do
    it 'should create an instance of GeoMentionsSearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::GeoMentionsSearchRequest)
    end
  end
