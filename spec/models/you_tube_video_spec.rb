...
# Unit tests for Unifapi::YouTubeVideo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::YouTubeVideo do
  let(:instance) { Unifapi::YouTubeVideo.new }

  describe 'test an instance of YouTubeVideo' do
    it 'should create an instance of YouTubeVideo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::YouTubeVideo)
    end
  end
