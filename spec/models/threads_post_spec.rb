...
# Unit tests for Unifapi::ThreadsPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::ThreadsPost do
  let(:instance) { Unifapi::ThreadsPost.new }

  describe 'test an instance of ThreadsPost' do
    it 'should create an instance of ThreadsPost' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::ThreadsPost)
    end
  end
