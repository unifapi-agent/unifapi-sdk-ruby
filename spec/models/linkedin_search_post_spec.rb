...
# Unit tests for Unifapi::LinkedinSearchPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::LinkedinSearchPost do
  let(:instance) { Unifapi::LinkedinSearchPost.new }

  describe 'test an instance of LinkedinSearchPost' do
    it 'should create an instance of LinkedinSearchPost' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::LinkedinSearchPost)
    end
  end
