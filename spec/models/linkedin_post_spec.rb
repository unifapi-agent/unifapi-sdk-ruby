...
# Unit tests for Unifapi::LinkedinPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::LinkedinPost do
  let(:instance) { Unifapi::LinkedinPost.new }

  describe 'test an instance of LinkedinPost' do
    it 'should create an instance of LinkedinPost' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::LinkedinPost)
    end
  end
