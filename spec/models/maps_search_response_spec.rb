...
# Unit tests for Unifapi::MapsSearchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::MapsSearchResponse do
  let(:instance) { Unifapi::MapsSearchResponse.new }

  describe 'test an instance of MapsSearchResponse' do
    it 'should create an instance of MapsSearchResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::MapsSearchResponse)
    end
  end
