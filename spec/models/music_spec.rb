...
# Unit tests for Unifapi::Music
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::Music do
  let(:instance) { Unifapi::Music.new }

  describe 'test an instance of Music' do
    it 'should create an instance of Music' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::Music)
    end
  end
