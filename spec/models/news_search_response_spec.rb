...
# Unit tests for Unifapi::NewsSearchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Unifapi::NewsSearchResponse do
  let(:instance) { Unifapi::NewsSearchResponse.new }

  describe 'test an instance of NewsSearchResponse' do
    it 'should create an instance of NewsSearchResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Unifapi::NewsSearchResponse)
    end
  end
